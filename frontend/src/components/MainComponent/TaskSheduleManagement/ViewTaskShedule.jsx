...
const ViewTaskShedule = ({ setIsViewTaskOpen, taskData }) => {
                ...
                <table className="w-full text-left border border-[#d1d5db] rounded-[5px]">
                  ...
                  <tbody>
                    <tr className="bg-white hover:bg-gray-50">
                      <td className="px-4 py-2 border-b border-[#e5e7eb] text-newtextdata cursor-pointer">
                        {taskData?.task?.task_title}
                      </td>
                      <td className="px-4 py-2 border-b border-[#e5e7eb] text-newtextdata cursor-pointer">
                        {taskData?.task?.assignedUser?.fullname}
                      </td>
                      <td className="px-4 py-2 border-b border-[#e5e7eb] text-newtextdata cursor-pointer">
                      ...
                      <td className="px-4 py-2 border-b border-[#e5e7eb] text-newtextdata cursor-pointer">
                        {taskData?.task?.due_date
                          ? new Date(taskData.task.due_date).toLocaleDateString(
                              "en-GB"
                            ) // 'dd/MM/yyyy'
                          : "-"}
                      </td>
                      <td className="px-4 py-2 border-b border-[#e5e7eb] text-newtextdata cursor-pointer">
                       ...
                       <td className="px-4 py-2 border-b border-[#e5e7eb] text-newtextdata cursor-pointer">
                        {taskData?.task?.salesperson_remark}
                      </td>
                    </tr>
                  </tbody>
                </table>
